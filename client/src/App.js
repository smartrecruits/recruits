    ...
    <div className="App">
      <>
        ...
        <Routes>
          ...
          <Route
            path="/intervieweescorelist/:id"
            element={<IntervieweeAssessments />}
          ></Route>
          <Route
            exact
            path="/intervieweescorelist"
            element={<IntervieweeScoreList />}
          ></Route>
          <Route path="/intervieweeList" element={<IntervieweeList />}></Route>
          <Route path="/assessments" element={<Invites />}></Route>
          <Route
            path="/assessments/:id"
            element={<OneAssessmentInterviewee />}
          ></Route>
          <Route path="/invites" element={<InvitesList />}></Route>
          <Route
            exact
            path="/RecruiterAssessList"
            element={<AssessmentsList />}
          ></Route>
          <Route
            path="/RecruiterAssessList/:id"
            element={<OneAssessment />}
          ></Route>
          <Route
            path="/RecruiterQuestionList"
