  ...
  return (
    <div className="section">
      <div className="section-text">
        <h2>Our Vision</h2>
        <p>Our vision is to create a world where everyone has access to a fulfilling career. We believe that work is about more than just a paycheck; it's about personal fulfillment, growth, and making a positive impact on the world.</p>
